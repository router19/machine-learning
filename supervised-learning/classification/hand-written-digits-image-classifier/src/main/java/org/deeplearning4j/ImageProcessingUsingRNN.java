...
public class ImageProcessingUsingRNN {
  // image information
  ...
  public static void main(String[] args) throws Exception {
    ...
    //log 10 labels
    System.out.println("10 labels to be tested are "+recordReader.getLabels().toString());
  ...
  private static DataSetIterator validateModel(FileSplit test,
                                               ImageRecordReader recordReader,
                                               DataNormalization scaler) throws IOException {
